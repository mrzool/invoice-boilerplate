...
\section*{\textsc{Rechnung} \#$invoice-nr$}
\footnotesize
\newcounter{pos}
\setcounter{pos}{0}
...
\begin{spreadtab}{{tabular}[t t t]{lp{8.2cm}r}}
  \hdashline[1pt/1pt]
  @ \noalign{\vskip 2mm} \textbf{Pos.} & @ \textbf{Beschreibung} & @
  \textbf{Betrag in $currency$} \\ \hline
  ...
  @ & @ \multicolumn{1}{r}{Zwischensumme:}                & :={sum(c1:[0,-1])} \\ \hhline{~~-}
  @ & @ \multicolumn{1}{r}{MwSt. $VAT$\%:}               & $VAT$/100*[0,-1] \\ \hhline{~~-}
  @ & @ \multicolumn{1}{r}{\textbf{Rechnungsbetrag:}}   & \textbf{:={[0,-1]+[0,-2]}} \\ \hhline{~~-}
\end{spreadtab}
