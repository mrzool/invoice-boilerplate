...
$if(watermark.text)$
    ...
    $if(watermark.scale)$ \SetWatermarkScale{$watermark.scale$} $endif$
    $if(watermark.color)$ \SetWatermarkColor[$watermark.color$]{$if(watermark.transparency)$ $watermark.transparency$ $endif$} $endif$
    $if(watermark.size)$ \SetWatermarkFontSize{$watermark.size$} $endif$
    $if(watermark.angle)$ \SetWatermarkAngle{$watermark.angle$} $endif$
$endif$
